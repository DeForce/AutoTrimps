...
function initializeAllSettings() {
    ...
    createSetting('ScryStopSuicide', 'Do not Scry on insta-kill', 'Stop your trimps suiciding in Scry formation if enemy will one-shot them', 'boolean', false, null, 'Scryer');
